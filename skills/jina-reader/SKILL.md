---
name: jina-reader
description: Jina Reader skill
version: 1.0.0
metadata:
  telegram_agent_os:
    public_template: true
    source_skill: jina-reader
---
...
This public skill template documents the `jina-reader` capability for a Telegram Agent OS deployment.

## When to use

Use this skill when the active role needs the procedures, checks, or domain knowledge associated with `jina-reader`.
