...
description: Youtube Watcher skill
version: 1.0.0
metadata:
  telegram_agent_os:
    public_template: true
    source_skill: youtube-watcher
---
...
This public skill template documents the `youtube-watcher` capability for a Telegram Agent OS deployment.

## When to use

Use this skill when the active role needs the procedures, checks, or domain knowledge associated with `youtube-watcher`.
