...
description: Using Git Worktrees skill
version: 1.0.0
metadata:
  telegram_agent_os:
...
This public skill template documents the `using-git-worktrees` capability for a Telegram Agent OS deployment.

## When to use

Use this skill when the active role needs the procedures, checks, or domain knowledge associated with `using-git-worktrees`.
