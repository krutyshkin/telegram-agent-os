...
metadata:
  telegram_agent_os:
    ...
    source_skill: popular-web-designs
---
...
| `telegram-agent-os.md` | Emerald Terminal | Void-black canvas, emerald accent, terminal-native |
...
- **Monospace / terminal aesthetic:** Ollama, OpenCode, x.ai, Emerald Terminal
