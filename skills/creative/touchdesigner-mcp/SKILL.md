...
description: "Control a running TouchDesigner instance via twozero MCP \u2014 create\
  \ operators, set parameters, wire connections, execute Python, build real-time visuals.\
  \ 36 native tools."
version: 1.1.0
metadata:
  telegram_agent_os:
    public_template: true
    source_skill: touchdesigner-mcp
---
