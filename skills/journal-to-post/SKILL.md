...
description: Journal To Post skill
version: 1.0.0
metadata:
  telegram_agent_os:
    public_template: true
    source_skill: journal-to-post
---
...
This public skill template documents the `journal-to-post` capability for a Telegram Agent OS deployment.

## When to use

Use this skill when the active role needs the procedures, checks, or domain knowledge associated with `journal-to-post`.
