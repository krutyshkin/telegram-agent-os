...
description: Verification Before Completion skill
version: 1.0.0
metadata:
  telegram_agent_os:
...
This public skill template documents the `verification-before-completion` capability for a Telegram Agent OS deployment.

## When to use

Use this skill when the active role needs the procedures, checks, or domain knowledge associated with `verification-before-completion`.
