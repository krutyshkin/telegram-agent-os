---
name: agent-registry
description: 'Telegram Agent OS orchestrator skill: agent-registry'
version: 1.0.0
metadata:
  telegram_agent_os:
    public_template: true
    source_skill: agent-registry
---
...
This public skill template documents the `agent-registry` capability for a Telegram Agent OS deployment.

## When to use

Use this skill when the active role needs the procedures, checks, or domain knowledge associated with `agent-registry`.
