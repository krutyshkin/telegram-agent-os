---
name: telegram-forum-topic-router
description: Telegram Forum Topic Router skill
version: 1.0.0
metadata:
  telegram_agent_os:
    public_template: true
    source_skill: telegram-forum-topic-router
---
...
This public skill template documents the `telegram-forum-topic-router` capability for a Telegram Agent OS deployment.

## When to use

Use this skill when the active role needs the procedures, checks, or domain knowledge associated with `telegram-forum-topic-router`.
