---
name: last30days-2
description: Last30Days 2 skill
version: 1.0.0
metadata:
  telegram_agent_os:
    public_template: true
    source_skill: last30days-2
---
...
This public skill template documents the `last30days-2` capability for a Telegram Agent OS deployment.

## When to use

Use this skill when the active role needs the procedures, checks, or domain knowledge associated with `last30days-2`.
