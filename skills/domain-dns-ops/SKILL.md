---
name: domain-dns-ops
description: Domain Dns Ops skill
version: 1.0.0
metadata:
  telegram_agent_os:
    public_template: true
    source_skill: domain-dns-ops
---
...
This public skill template documents the `domain-dns-ops` capability for a Telegram Agent OS deployment.

## When to use

Use this skill when the active role needs the procedures, checks, or domain knowledge associated with `domain-dns-ops`.
