...
description: High End Visual Design skill
version: 1.0.0
metadata:
  telegram_agent_os:
    public_template: true
    source_skill: high-end-visual-design
---
...
This public skill template documents the `high-end-visual-design` capability for a Telegram Agent OS deployment.

## When to use

Use this skill when the active role needs the procedures, checks, or domain knowledge associated with `high-end-visual-design`.
