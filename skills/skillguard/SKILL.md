---
name: skillguard
description: Skillguard skill
version: 1.0.0
metadata:
  telegram_agent_os:
    public_template: true
    source_skill: skillguard
---
...
This public skill template documents the `skillguard` capability for a Telegram Agent OS deployment.

## When to use

Use this skill when the active role needs the procedures, checks, or domain knowledge associated with `skillguard`.
