---
name: paid-ads
description: Paid Ads skill
version: 1.0.0
metadata:
  telegram_agent_os:
    public_template: true
    source_skill: paid-ads
---
...
This public skill template documents the `paid-ads` capability for a Telegram Agent OS deployment.

## When to use

Use this skill when the active role needs the procedures, checks, or domain knowledge associated with `paid-ads`.
