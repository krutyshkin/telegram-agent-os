...
description: Nodejs Backend Patterns skill
version: 1.0.0
metadata:
  telegram_agent_os:
    public_template: true
    source_skill: nodejs-backend-patterns
---
...
This public skill template documents the `nodejs-backend-patterns` capability for a Telegram Agent OS deployment.

## When to use

Use this skill when the active role needs the procedures, checks, or domain knowledge associated with `nodejs-backend-patterns`.
