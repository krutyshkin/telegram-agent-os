...
metadata:
  telegram_agent_os:
    ...
    source_skill: compound-engineering
---
...
This public skill template documents the `compound-engineering` capability for a Telegram Agent OS deployment.

## When to use

Use this skill when the active role needs the procedures, checks, or domain knowledge associated with `compound-engineering`.
