---
name: readme-i18n
description: Readme I18N skill
version: 1.0.0
metadata:
  telegram_agent_os:
    public_template: true
    source_skill: readme-i18n
---
...
This public skill template documents the `readme-i18n` capability for a Telegram Agent OS deployment.

## When to use

Use this skill when the active role needs the procedures, checks, or domain knowledge associated with `readme-i18n`.
