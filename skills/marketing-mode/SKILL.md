---
name: marketing-mode
description: Marketing Mode skill
version: 1.0.0
metadata:
  telegram_agent_os:
    public_template: true
    source_skill: marketing-mode
---
...
This public skill template documents the `marketing-mode` capability for a Telegram Agent OS deployment.

## When to use

Use this skill when the active role needs the procedures, checks, or domain knowledge associated with `marketing-mode`.
