...
This public skill template documents the `frontend-design` capability for a Telegram Agent OS deployment.

## When to use

Use this skill when the active role needs the procedures, checks, or domain knowledge associated with `frontend-design`.
