...
description: Self Improving Agent skill
version: 1.0.0
metadata:
  telegram_agent_os:
...
This public skill template documents the `self-improving-agent` capability for a Telegram Agent OS deployment.

## When to use

Use this skill when the active role needs the procedures, checks, or domain knowledge associated with `self-improving-agent`.
