...
description: Clawdbot Security skill
version: 1.0.0
metadata:
  telegram_agent_os:
    public_template: true
    source_skill: clawdbot-security
---
...
This public skill template documents the `clawdbot-security` capability for a Telegram Agent OS deployment.

## When to use

Use this skill when the active role needs the procedures, checks, or domain knowledge associated with `clawdbot-security`.
