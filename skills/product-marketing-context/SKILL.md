...
description: Product Marketing Context skill
version: 1.0.0
metadata:
  telegram_agent_os:
    public_template: true
    source_skill: product-marketing-context
---
...
This public skill template documents the `product-marketing-context` capability for a Telegram Agent OS deployment.

## When to use

Use this skill when the active role needs the procedures, checks, or domain knowledge associated with `product-marketing-context`.
