...
description: Launch Strategy skill
version: 1.0.0
metadata:
  telegram_agent_os:
    public_template: true
    source_skill: launch-strategy
---
...
This public skill template documents the `launch-strategy` capability for a Telegram Agent OS deployment.

## When to use

Use this skill when the active role needs the procedures, checks, or domain knowledge associated with `launch-strategy`.
