...
This public skill template documents the `systematic-debugging` capability for a Telegram Agent OS deployment.

## When to use

Use this skill when the active role needs the procedures, checks, or domain knowledge associated with `systematic-debugging`.
