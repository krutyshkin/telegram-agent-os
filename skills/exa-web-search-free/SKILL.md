...
description: Exa Web Search Free skill
version: 1.0.0
metadata:
  telegram_agent_os:
    public_template: true
    source_skill: exa-web-search-free
---
...
This public skill template documents the `exa-web-search-free` capability for a Telegram Agent OS deployment.

## When to use

Use this skill when the active role needs the procedures, checks, or domain knowledge associated with `exa-web-search-free`.
