...
description: N8N Workflow Automation skill
version: 1.0.0
metadata:
  telegram_agent_os:
    public_template: true
    source_skill: n8n-workflow-automation
---
...
This public skill template documents the `n8n-workflow-automation` capability for a Telegram Agent OS deployment.

## When to use

Use this skill when the active role needs the procedures, checks, or domain knowledge associated with `n8n-workflow-automation`.
