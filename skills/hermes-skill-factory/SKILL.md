...
description: Hermes Skill Factory skill
version: 1.0.0
metadata:
  telegram_agent_os:
    public_template: true
    source_skill: hermes-skill-factory
---
...
This public skill template documents the `hermes-skill-factory` capability for a Telegram Agent OS deployment.

## When to use

Use this skill when the active role needs the procedures, checks, or domain knowledge associated with `hermes-skill-factory`.
