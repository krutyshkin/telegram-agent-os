---
name: perplexity-2
description: Perplexity 2 skill
version: 1.0.0
metadata:
  telegram_agent_os:
    public_template: true
    source_skill: perplexity-2
---
...
This public skill template documents the `perplexity-2` capability for a Telegram Agent OS deployment.

## When to use

Use this skill when the active role needs the procedures, checks, or domain knowledge associated with `perplexity-2`.
