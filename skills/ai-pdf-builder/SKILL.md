---
name: ai-pdf-builder
description: Ai Pdf Builder skill
version: 1.0.0
metadata:
  telegram_agent_os:
    public_template: true
    source_skill: ai-pdf-builder
---
...
This public skill template documents the `ai-pdf-builder` capability for a Telegram Agent OS deployment.

## When to use

Use this skill when the active role needs the procedures, checks, or domain knowledge associated with `ai-pdf-builder`.
