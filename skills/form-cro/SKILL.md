---
name: form-cro
description: Form Cro skill
version: 1.0.0
metadata:
  telegram_agent_os:
    public_template: true
    source_skill: form-cro
---
...
This public skill template documents the `form-cro` capability for a Telegram Agent OS deployment.

## When to use

Use this skill when the active role needs the procedures, checks, or domain knowledge associated with `form-cro`.
