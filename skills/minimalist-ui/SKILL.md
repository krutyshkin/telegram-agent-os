---
name: minimalist-ui
description: Minimalist Ui skill
version: 1.0.0
metadata:
  telegram_agent_os:
    public_template: true
    source_skill: minimalist-ui
---
...
This public skill template documents the `minimalist-ui` capability for a Telegram Agent OS deployment.

## When to use

Use this skill when the active role needs the procedures, checks, or domain knowledge associated with `minimalist-ui`.
